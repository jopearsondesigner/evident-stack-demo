...
Default.args = {
  ...
  audiences: [{title: "A named audience",
             ...
             {title: "Another named audience",
              placements: [,{id: "5", title: "An interface!", description: "blah *blah* **blah**"},,,,
  ...
  [,{id: "5", title: "A command!", type: "command", description: "blah *blah* **blah**"},,
   ...
   {id: "8", title: "Another read model!", type: "readModel", description: "blah *blah* **blah**"}],
  streams: [{title: "A named stream",
             placements: [,,,{id: "9", title: "An event!", description: "blah *blah* **blah**"},,,,,,,,,,
