...
<div class="bg-black dark:bg-white bg-opacity-[4%] dark:bg-opacity-[4%] pb-24">
	<Container class="sm:container pb-4">
		<SectionLabel>Evident team</SectionLabel>
	</Container>
		...
		<Row class="grid gap-12" customCols="lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
			<Column class="lg:grid-cols-1">
				<Card
					img={Bobby}
					size="sm"
					cardClass="min-h-full mx-6 bg-white dark:bg-dark-1 border border-border-light dark:border-border-dark p-4 rounded-lg shadow-lg"
					imgClass="mb-10 mt-10 mx-auto"
					width={155}
				>
					<Section name="general">
						<SectionHeader
							tag="h4"
							hClass="leading-[1.27] font-bold font-header mb-4 text-center"
							customSize="lg:text-[24px] text-[24px] "
							color="text-gray-brand-2 dark:text-gray-brand-4"
						>
							Bobby Calderwood
						</SectionHeader>
						<SectionCopy
							pClass="uppercase text-gray-primary dark:text-gray-brand-4 leading-[1.27] font-bold font-header mb-2 text-center"
							textSize="text-xs"
						>
							Founder & Sofware Engineer
						</SectionCopy>
						<SectionCopy
							pClass="leading-normal text-center px-4 mb-10 text-body-light dark:text-body-dark"
				...
				>
					<Section name="general">
						...
						<SectionCopy
							...
							textSize="text-medium"
						>
							Jo’s Love Languages include Words of Affirmation, State-of-the-art Apps, and Sweet
							Design.
						</SectionCopy>
					</Section>
				</Card>
			...
			<Section name="general">
				...
				<SectionCopy class="my-4 text-center">
					<A
						...
						href="https://www.linkedin.com/in/bobbycalderwood/">Bobby Calderwood</A
					> founded Evident Systems LLC in 2018 to help companies build event-based information systems.
					He has <A
						class="transition duration-300 ease-in"
						href="https://www.youtube.com/watch?v=B1-gS0oEtYc">spoken at conferences</A
					> and <A
						class="transition duration-300 ease-in"
						href="https://www.confluent.io/blog/toward-functional-programming-analogy-microservices/"
						>written about</A
					> achieving better software architecture by focusing on business events.
				</SectionCopy>
			</Section>
		</Column>
	</Row>
