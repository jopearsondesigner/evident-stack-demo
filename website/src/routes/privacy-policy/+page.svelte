...
<Container>
    ...
    <Section name='terms' sectionClass='px-4 mt-8 pb-[128px]'>
        ...
        <SectionCopy class='mb-4'>
            Email Address: <A href='mailto:legal@evidentsystems.com' class='transition duration-300 ease-in inline-flex'>legal@evidentsystems.com</A>
        </SectionCopy>
        <SectionCopy class='mb-4'>
            Telephone number: (703) 259-1199
        </SectionCopy>
        <SectionCopy class='mb-4'>
