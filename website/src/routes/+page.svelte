...
<Hero>
    <Navbar navbarWebClass='absolute bg-transparent shadow-none w-full max-h-12 px-3 py-1.5 text-body z-10' {website}>
        <NavWrapper>
    ...
    <HeroContainer>
        <HeroGrid>
            ...
            <HeroFlexbox class={classNames('flex-row lg:order-last order-first mx-auto', heroFlexboxClass)}>
                <HeroImage>
                    <img
                    src={ForegroundImage}
