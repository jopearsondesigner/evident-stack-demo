...
<div
  ...
  class="placement interface z-20 flex place-self-center align-items-center col-border ring-white p-[1.4375rem] -ml-px mb-px hover:bg-focus/[.18] transition duration-200 ease-in"
