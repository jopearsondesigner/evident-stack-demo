...
<MaybeTooltip tip={descriptionHTML}>
  <div
    ...
    class="readModel m-[1.4375rem] w-[6.125rem] h-[6.125rem] p-3 overflow-visible text-left text-node font-semibold leading-tight bg-gradient-to-b from-readModel to-readModel-light"
  >
    {name}
  </div>
</MaybeTooltip>
