import { c as create_ssr_component, d as compute_rest_props, f as spread, g as escape_attribute_value, h as escape_object, b as add_attribute, v as validate_component, e as escape, j as each } from '../../../../chunks/index3.js';
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/UI/Anchor.svelte generated by Svelte v3.59.1 */
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/UI/Button.svelte generated by Svelte v3.59.1 */

const css$6 = {
	code: "button.svelte-1ryyn5{display:flex;align-items:center;justify-content:center;gap:8px;border-radius:var(--radii-borderRadiusButton);font-size:var(--fontSizes-baseButtonSize);padding:var(--space-buttonPadding);cursor:pointer;border-width:var(--borderWidths-buttonBorderWidth);border-style:solid;width:100%;transition-property:background-color;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:100ms}button.default.svelte-1ryyn5{background-color:var(--colors-defaultButtonBackground);color:var(--colors-defaultButtonText);border-color:var(--colors-defaultButtonBorder)}button.default.svelte-1ryyn5:hover{background-color:var(--colors-defaultButtonBackgroundHover)}button.primary.svelte-1ryyn5{background-color:var(--colors-brand);color:var(--colors-brandButtonText);border-color:var(--colors-brandAccent)}button.primary.svelte-1ryyn5:hover{background-color:var(--colors-brandAccent)}",
	map: null
};
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<button${spread(
		...
		{ classes: "svelte-1ryyn5" }
	)}>${slots.default ? slots.default({}) : ``}
</button>`;
});

/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/UI/Container.svelte generated by Svelte v3.59.1 */
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/UI/Input.svelte generated by Svelte v3.59.1 */
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/UI/Label.svelte generated by Svelte v3.59.1 */
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/interfaces/EmailAuth.svelte generated by Svelte v3.59.1 */

const css$5 = {
	code: "form.svelte-n0qhpo{width:100%}",
	map: null
};
...
const EmailAuth = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	let { redirectTo = undefined } = $$props;
	...
	do {
		...
		$$rendered = `<form method="post" class="svelte-n0qhpo">${validate_component(Container, "Container").$$render(
			$$result,
			{
				direction: "vertical",
				gap: "large",
			...
			<div>${validate_component(Label, "Label").$$render($$result, { for: "password", appearance }, {}, {
				...
				${validate_component(Input, "Input").$$render(
									$$result,
									{
										...
										autocomplete: authView === VIEWS.SIGN_IN
										? 'current-password'
										: 'new-password',
										appearance,
										value: password
		...
		${showLinks
					? `${validate_component(Container, "Container").$$render(
							...
							{
								default: () => {
									return `${authView === VIEWS.SIGN_IN && magicLink
									? `${validate_component(Anchor, "Anchor").$$render($$result, { href: "#auth-magic-link", appearance }, {}, {
											default: () => {
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/interfaces/ForgottenPassword.svelte generated by Svelte v3.59.1 */
...
const ForgottenPassword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<form id="auth-forgot-password" method="post" class="svelte-n0qhpo">${validate_component(Container, "Container").$$render(
			$$result,
			{
				direction: "vertical",
				gap: "large",
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/interfaces/MagicLink.svelte generated by Svelte v3.59.1 */
...
const MagicLink = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<form id="auth-magic-link" method="post" class="svelte-n0qhpo">${validate_component(Container, "Container").$$render(
			$$result,
			{
				direction: "vertical",
				gap: "large",
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/Icons.svelte generated by Svelte v3.59.1 */

const css$2 = {
	code: "svg.svelte-7ers0{height:21px;width:21px}",
	map: null
};
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/interfaces/SocialAuth.svelte generated by Svelte v3.59.1 */
...
const SocialAuth = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	${!onlyThirdPartyProviders
		? `${validate_component(Divider, "Divider").$$render($$result, { appearance }, {}, {})}`
		: ``}`
	: ``}`;
});
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/interfaces/UpdatePassword.svelte generated by Svelte v3.59.1 */
...
const UpdatePassword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<form id="auth-update-password" method="post" class="svelte-n0qhpo">${validate_component(Container, "Container").$$render(
			$$result,
			{
				direction: "vertical",
				gap: "large",
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/interfaces/VerifyOtp.svelte generated by Svelte v3.59.1 */
...
const VerifyOtp = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<form id="auth-magic-link" method="post" class="svelte-n0qhpo">${validate_component(Container, "Container").$$render(
			...
			{
				default: () => {
					return `${['sms', 'phone_change'].includes(otpType)
					? `<div>${validate_component(Label, "Label").$$render($$result, { for: "phone", appearance }, {}, {
							default: () => {
				...
				${validate_component(Input, "Input").$$render(
					...
					: `<div>${validate_component(Label, "Label").$$render($$result, { for: "email", appearance }, {}, {
							default: () => {
...
/* Users/josephpearson/Documents/platform/node_modules/@supabase/auth-ui-svelte/dist/Auth/Auth.svelte generated by Svelte v3.59.1 */
...
const Auth = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	let { providers = [] } = $$props;
	let { providerScopes = undefined } = $$props;
	let { queryParams = undefined } = $$props;
	...
	do {
		...
		$$rendered = `<div${add_attribute("class", theme !== 'default' ? themeVariables : '', 0)}>${SignView
		? `${validate_component(SocialAuth, "SocialAuth").$$render(
				$$result,
				{
					appearance,
					supabaseClient,
	...
	${view === VIEWS.SIGN_IN
		? `${!onlyThirdPartyProviders
			? `${validate_component(EmailAuth, "EmailAuth").$$render(
					$$result,
					{
						appearance,
						supabaseClient,
	...
	${view === VIEWS.SIGN_UP
		? `${!onlyThirdPartyProviders
			...
			: ``}`
		: ``}
	${view === VIEWS.FORGOTTEN_PASSWORD
		? `${validate_component(ForgottenPassword, "ForgottenPassword").$$render(
				$$result,
				{
					i18n,
					supabaseClient,
	...
	${view === VIEWS.MAGIC_LINK
		? `${validate_component(MagicLink, "MagicLink").$$render(
				$$result,
				{
					i18n,
					supabaseClient,
	...
	${view === VIEWS.UPDATE_PASSWORD
		? `${validate_component(UpdatePassword, "UpdatePassword").$$render(
				$$result,
				{
					i18n,
					supabaseClient,
	...
	${view === VIEWS.VERIFY_OTP
		? `${validate_component(VerifyOtp, "VerifyOtp").$$render(
				$$result,
				{
					i18n,
					supabaseClient,
...
/* src/routes/(non-project)/auth/+page.svelte generated by Svelte v3.59.1 */
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${($$result.head += '<!-- HEAD_svelte-wfl00f_START -->' + `${($$result.title = `<title>Login | Evident Stack</title>`, "")}` + '<!-- HEAD_svelte-wfl00f_END -->', "")}

<div class="container mx-auto p-10"><h1>Login</h1>
