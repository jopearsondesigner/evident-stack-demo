...
<div
	{id}
	class="placement command z-20 flex place-self-center align-items-center p-[1.375rem] border-r border-white -ml-px mb-0.5 hover:bg-focus/[.18] transition duration-200 ease-in"
	class:cursor
