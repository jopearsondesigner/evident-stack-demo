...
<Container>
  ...
  <Section name="blog" divClass="md:pt-16 pt-0 pb-[136px]">
    <Row customCols="lg:grid-cols-6">
      ...
      >
        <FeaturedBadge />
        <A href="/webinars/real-time-collaborative-event-modeling-with-onote"
          ><img
            src={FeaturedBlogImage}
            alt="Real-time Collaborative Event Modeling with oNote"
      ...
      >
        <Article>
          ...
          <Section name="blog">
            ...
            <SectionCopy>
              <div class="line-clamp-4">
                This webinar will cover oNote’s Real-Time Collaboration. Attendees will have the
                opportunity to peek under the hood and see how it was built. We will also hear from
                Martin Kleppmann (Pre Recorded), Mike Shearer (lead Engineer), and Bobby Calderwood
                (Founder of oNote). The oNote team will walk through starting a session, joining a
                session, and allow everyone to see how the interactions in the environment look as
                well. This is an opportunity to see where the future of software design and
          ...
          <Section
            ...
            divClass="w-full"
          >
            <div class="text-sm text-gray-brand-4 mt-4">2022-02-23</div>
      ...
      >
        <Article customMargin="mt-0">
          ...
          <Section name="blog" divClass="h-full">
            ...
            <div class="text-sm text-gray-brand-4 mt-4">2021-12-15</div>
          </Section>
        </Article>
      </Column>
      <Column
      ...
      >
        <Article customMargin="mt-0">
          <A
            ...
            ><img src={BlogImage2} alt="Event Modeling Explained" class="object-cover" /></A
          >
          <p
            class="text-sm text-black text-opacity-90 dark:text-gray-primary uppercase font-bold lg:pt-0 mt-2 mb-4"
          >
          ...
          <Section name="blog" divClass="h-full">
            ...
            <div class="text-sm text-gray-brand-4 mt-4">2021-11-10</div>
          </Section>
        </Article>
      </Column>
    </Row>
