...
{#if stream.name}
  <h3
    class="streamName laneName sticky left-3 justify-self-start self-end cursor-pointer prose text-body-light nndark:text-body-dark mb-3"
...
{:else}
  ...
  <h3
    class="streamName sticky left-3 justify-self-start self-end prose text-body-light dark:text-body-dark mb-3"
    style="grid-column: 1 / -1; grid-row: {gridRow} / {gridRow};"
  >
    Default Stream
  </h3>
