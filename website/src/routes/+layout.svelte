<script lang='ts'>
    ...
    import NavHamburger from 'components/websitenavbar/NavHamburger.svelte';
    ...
    import MobileNav from 'components/websitenavbar/MobileNav.svelte';
...
<slot/>
{:else}
<div class={backdropDivClass}/><slot/>
{/if}
